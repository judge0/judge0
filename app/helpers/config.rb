module Config
  ...
  CPU_TIME_LIMIT = (ENV['CPU_TIME_LIMIT'].presence || 15).to_f
  MAX_CPU_TIME_LIMIT = (ENV['MAX_CPU_TIME_LIMIT'].presence || 20).to_f
  CPU_EXTRA_TIME = (ENV['CPU_EXTRA_TIME'].presence || 1).to_f
  MAX_CPU_EXTRA_TIME = (ENV['MAX_CPU_EXTRA_TIME'].presence || 5).to_f
  WALL_TIME_LIMIT = (ENV['WALL_TIME_LIMIT'].presence || 20).to_f
  MAX_WALL_TIME_LIMIT = (ENV['MAX_WALL_TIME_LIMIT'].presence || 25).to_f
  ...
  MAX_PROCESSES_AND_OR_THREADS = (ENV['MAX_PROCESSES_AND_OR_THREADS'].presence || 100).to_i
  ...
  MAX_FILE_SIZE = (ENV['MAX_FILE_SIZE'].presence || 5120).to_i
  MAX_MAX_FILE_SIZE = (ENV['MAX_MAX_FILE_SIZE'].presence || 20480).to_i

module IsolateRunner
  ...
  def self.perform_now(submission, return_stdout = false)
    IsolateRunner.perform_later(submission, return_stdout)
  ...
  def self.perform_later(submission, return_stdout = false)
